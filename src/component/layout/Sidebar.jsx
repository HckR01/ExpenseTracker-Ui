...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <aside className={`fixed md:sticky top-0 left-0 h-screen w-64 bg-white dark:bg-slate-800 border-r border-gray-100 dark:border-slate-700 p-6 flex flex-col transition-transform duration-300 z-50 ${
